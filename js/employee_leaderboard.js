...
async function loadLeaderboard() {
    ...
    leaderboardData.sort((a, b) => b.totalGMV - a.totalGMV);

    leaderboardData.forEach((employee, login) => {
...
function getEmployeeName(profile) {
    ...
    return profile.username || profile.email || 'Unknown Employee';
}
...
function showLeaderboardLoading() {
    document.getElementById('leaderboardLoading').classList.remove('d-none');

    document.getElementById('leaderboardError').classList.add('d-none');

    document.getElementById('podium').classList.add('d-none');

    document.getElementById('leaderboardList').classList.add('d-none');
}
...
function showLeaderboardEmpty() {
    document.getElementById('leaderboardEmpty').classList.remove('d-none');
}
